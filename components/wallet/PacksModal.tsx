...
const PACKS = [
  { id: '10', name: 'Test', likes: 10, price: 0 },
  { id: '100', name: 'Starter', likes: 100, price: 0 },
  { id: '500', name: 'Popular', likes: 500, price: 0, popular: true },
  { id: '1000', name: 'Pro', likes: 1000, price: 0 },
]
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/95 backdrop-blur-sm animate-fadeIn">
      <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 max-w-lg w-full">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent">Free Likes - BETA</h2>
        ...
        <p className="text-gray-400 text-sm mb-6">🎉 Profitez des likes gratuits pendant la beta! Paiements Stripe bientôt disponibles.</p>
        <div className="grid grid-cols-2 gap-4">
          {PACKS.map((pack) => (
            <button key={pack.id} onClick={() => handleBuyPack(pack.likes)} className={`relative p-6 rounded-2xl border-2 transition-all duration-300 hover:scale-105 ${pack.popular ? 'border-green-400 bg-green-400/10' : 'border-zinc-700 hover:border-green-400'}`}>
